...
function BaseModal({
  ...
  return (
    <animated.aside
      {...props}
      style={animation}
      className="absolute z-[999] flex h-screen w-screen items-center justify-center bg-black/70 px-6 xl:px-0"
      id="modal"
    >
      <animated.div
        style={modalAnimation}
        className={cn(
          'z-[999] w-full max-w-lg rounded-3xl bg-[#cdd0d5] text-base text-[#2d2b2b]',
          props.className,
        )}
      >
        {!withoutHeader && (
